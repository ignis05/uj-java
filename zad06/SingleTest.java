...
public class SingleTest {
  ...
  public static void main(String[] args) {
    ...
    String inpSequence = "10010 11111 11100 11111 01111 11011 11111 11100 11100 11101 11110 11010 11111 11100 10011 11111 11101 10010 11011 10001 11101";

    System.out.println("input (" + getSequenceLenght(inpSequence) + "):\n" + inpSequence);
    ...
    System.out.println("====");
    System.out.println("header (" + getHeaderLength(header) + "):\n" + header);
    System.out.println("====");
    System.out.println("output (" + getSequenceLenght(outSequence) + "):\n" + outSequence);
    System.out.println("====");

...
public class Test04 {
  ...
  public static void main(String[] args) {
    ...
    expPair.put(new BusLine.LinesPair("b", "a"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("c", "b"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("a", "a"), new HashSet<Position>(List.of(new Position2D(4, 4))));
    expPair.put(new BusLine.LinesPair("b", "b"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("c", "c"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("a", "b"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("b", "c"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("a", "c"), new HashSet<Position>(List.of(new Position2D(7, 2), new Position2D(7, 4))));
    expPair.put(new BusLine.LinesPair("c", "a"), new HashSet<Position>(List.of(new Position2D(7, 2), new Position2D(7, 4))));
    expPair.put(new BusLine.LinesPair("p1", "p1"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p1", "p2"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p1", "a"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p1", "b"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p1", "c"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p2", "p1"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p2", "p2"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p2", "a"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p2", "b"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("p2", "c"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("a", "p1"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("a", "p2"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("b", "p1"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("b", "p2"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("c", "p1"), new HashSet<Position>(List.of()));
    expPair.put(new BusLine.LinesPair("c", "p2"), new HashSet<Position>(List.of()));
